<template>
  ...
  <div
    ...
    <div
      v-if="GET_CURRENT_USER_UUID"
      class="mobile_view_topbar">
      <div
        @click="TOGGLE_CHAT_TAB('Chats')"
        class="btn_back">
    ...
    class="msglistLoading">
      <div class="msglistLoading_content">
    ...
    <MessengerInput
    v-if="GET_CURRENT_CHAT_ROOM_UUID"
    />
